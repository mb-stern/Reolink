...
- Neue API-Funktion 'Mailversand'. Die Konfiguration ist im Kameraintrface vorzunehmen. Im Modul kann die Funktion de/aktiviert (zb bei Abwesenheit) und das Versand-Intervall eingestellt werden.
