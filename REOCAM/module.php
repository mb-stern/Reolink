    ...
    public function Create()
{
    ...
    // Schalter zum Ein-/Ausblenden von Variablen, Schnappschüssen und Archiven
    ...
    $this->RegisterPropertyBoolean("ShowArchives", true); // Archiv-Schalter
    $this->RegisterPropertyInteger("MaxArchiveImages", 20); // Maximale Anzahl der Archivbilder
...
private function CreateOrUpdateArchives()
{
    ...
    foreach ($categories as $category) {
        ...
        // Vorhandene Schnappschüsse kopieren
...
private function CopySnapshotToArchive($snapshotID, $categoryID, $maxImages)
{
    ...
    if (file_exists($snapshotPath)) {
        ...
        // Archiv auf maximale Anzahl begrenzen
